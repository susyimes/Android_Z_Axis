...
public class DepthLayout extends RelativeLayout {
    ...
    public boolean calculateBounds() {
        ...
        float[] dst = new float[]{0, 0, 0,0, 0, getHeight(), getWidth(), getHeight()/2};
        //float[] dst = new float[]{getHeight()/2, getHeight()/2, getHeight()/2,getHeight()/2, getHeight()/2, getHeight()/2, getWidth()/2, getHeight()/2};
        ...
        bottomRight.x = src[4] + getLeft();
        bottomRight.y = src[5] + getTop();
        bottomLeft.x = src[6] + getLeft();
        bottomLeft.y = src[7] + getTop();
      ...
      /*  topLeft.x = src[0] ;
        ...
        dst = new float[]{0, 0, 0, 0, 0, getHeight(), getWidth(), getHeight()/2};
        ...
        bottomRightBack.x = src[4] + getLeft();
        bottomRightBack.y = src[5] + getTop();
        bottomLeftBack.x = src[6] + getLeft();
        bottomLeftBack.y = src[7] + getTop();
